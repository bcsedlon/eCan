...
public class AlarmManagerBroadcastReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
        ...
        final String channelNo = settings.getString(PREFS_NAME_CHANNEL_NO, "");
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try  {
                    ...
                    Log.e(TAG, "https://api.thingspeak.com/channels/" + channelNo + "/fields/1.json?results=1");
                    response = request("https://api.thingspeak.com/channels/" + channelNo + "/fields/1.json?results=1").toString();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
